...
class User:
    ...
    access_level: int
    joined_organisations: List[str] = field(default_factory=list)
    ...
    def from_json(data: Dict) -> "User":
        ...
        return User(
            ...
            joined_organisations=data.get("joinedOrganisations", []),
            ...
            current_organisation_id=data.get("currentOrganisationId"),
        )